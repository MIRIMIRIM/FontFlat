...
/// <summary>
/// Mutable builder for GSUB ExtensionSubst subtables (lookup type 7), format 1.
/// </summary>
public sealed class GsubExtensionSubstSubtableBuilder
{
    ...
    private byte[] BuildBytes()
    {
        if (_subtableData.IsEmpty)
            throw new InvalidOperationException("ExtensionSubst subtable is not configured. Call SetSubtableData(...).");
