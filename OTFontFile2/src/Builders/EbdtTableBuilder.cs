...
/// <summary>
/// Mutable builder for the OpenType <c>EBDT</c> table.
/// </summary>
[OtTableBuilder("EBDT", Mode = OtTableBuilderMode.Streaming)]
public sealed partial class EbdtTableBuilder : ISfntTableSource
{
    ...
    public static bool TryFrom(EbdtTable ebdt, out EbdtTableBuilder builder)
    {
        var b = new EbdtTableBuilder
        {
            Version = ebdt.Version
        };

        var span = ebdt.Table.Span;
